...
class VilarOscillator(Model):
    def __init__(self, parameter_values=None):
        ...
        self.add_reaction([r1, r2, r3, r4, r5, r6, r7, r8, r9, r10, r11, r12, r13, r14, r15, r16])
...
class LacOperon(Model):
    ...
    def __init__(self, parameter_values=None):
        ...
        j7 = Reaction(
            ...
            reactants={s6: 2, s3: 1},
            products={s8: 1},
            propensity_function="((3e-7)/((8e-16)*(6.0221367e14))**(2))*(R2)*(I)*(I-1)",
        )
        ...
        j9 = Reaction(
            ...
            reactants={s6: 2, s5: 1},
            products={s8: 1, s4: 1},
            propensity_function="((3e-7)/((8e-16)*(6.0221367e14))**(2))*(R2O)*(I)*(I-1)",
        )
...
class ToggleSwitch(Model):
    ...
    def __init__(self, parameter_values=None):
        ...
        # Reactions
        self.add_reaction(
            Reaction(name="cu", reactants={}, products={"A": 1}, propensity_function="alpha1/(1+pow(B, beta))")
        )
        self.add_reaction(
            Reaction(name="cv", reactants={}, products={"B": 1}, propensity_function="alpha2/(1+pow(A, gamma))")
        )
...
class RobustModel(Model):
    def __init__(self, parameter_values=None):
        ...
        # Reactions
        self.add_reaction(
            Reaction(name="r1", reactants={"s1": 1}, products={"s2": 1}, rate=self.listOfParameters["k2"])
        )
